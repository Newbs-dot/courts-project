...
doc_name3 = 'test_documents\A83-19868-2020_20201207_Opredelenie (1).pdf'
parser = Parser('./spacy_models/output237/model-best','./spacy_models/output237_sums/model-last')
